...
export default function Dashboard(){
  ...
  if(!sendMoney){
    ...
    <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-extrabold text-gray-800 tracking-tight">ProPay</h1>
                ...
                <div key={user.id} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-200">
                    <div className="flex justify-between items-center">
                        ...
                        <button
                            ...
                            className="bg-purple-500 text-white px-5 py-2 rounded-md hover:bg-purple-600 transition-colors duration-150"
                        >
                            Send Money
                        </button>
                    </div>
